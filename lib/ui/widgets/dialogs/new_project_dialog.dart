          ...
          children: <Widget>[
            Expanded(
              ...
              child: Container(
                ...
                child: Text("Widget Maker", style: Theme.of(context).textTheme.bodyText2,)
              )
            ),
            Expanded(
              flex: 7,
                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Start from scratch", style: Theme.of(context).textTheme.subtitle1,),
                        SizedBox(height: 8,),
                        DialogOption(
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Text("Start from template", style: Theme.of(context).textTheme.subtitle1,),
                        SizedBox(height: 8,),
                        DialogOption(
                          text: "Hello Word",
