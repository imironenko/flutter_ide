  ...
  CupertinoButtonElement({
    ...
    double? pressedOpacity,
        ...
        minSize = MDoubleProperty(
            value: minSize ?? null, name: "minSize", defaultValue: null),
...
class CupertinoButtonElementWidget extends StatefulWidget
  ...
  @override
  _CupertinoButtonElementWidgetState createState() =>
      _CupertinoButtonElementWidgetState();
}

class _CupertinoButtonElementWidgetState
    extends State<CupertinoButtonElementWidget>
    with
        ElementWidgetStateMixin<CupertinoButtonElement,
            CupertinoButtonElementWidget> {
  @override
