...
class R2D2 {
  ...
  PaletteItem scaffold = PaletteItem(
    ...
    icon: Icons.add,
    widget: DScaffold(),
    categories: ["Layout", "App Essentials"],
  ...
  PaletteItem rotatedBox = PaletteItem(
    ...
    icon: Icons.add,
    widget: DRotatedBox(),
    categories: ["Child Transformation"],
  ...
  PaletteItem raisedButton = PaletteItem(
    ...
    categories: ["None"],
    generator: (id) => ElevatedButtonElement(id: id),
  );
  ...
  Map<String, List<PaletteItem>> get categories => {
        ...
        "App Essentials": [appBar, floatingActionButton, scaffold, listTile],
        "Layout": [sizedBox, scaffold, padding, wContainer, wAnimatedContainer],
